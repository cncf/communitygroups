...
exports.EventLoopUtilizationCollector = exports.ATTR_NODEJS_EVENT_LOOP_UTILIZATION = void 0;
/*
...
exports.ATTR_NODEJS_EVENT_LOOP_UTILIZATION = 'eventloop.utilization';
class EventLoopUtilizationCollector extends baseCollector_1.BaseCollector {
    ...
    updateMetricInstruments(meter) {
        meter
            .createObservableGauge(`${this.namePrefix}.${exports.ATTR_NODEJS_EVENT_LOOP_UTILIZATION}`, {
