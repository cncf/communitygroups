 ...
 *
 */
export declare const ATTR_DB_SYSTEM = "db.system.name";
/**
 ...
 * @experimental This attribute is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
export declare const ATTR_DB_STATEMENT = "db.query.text";
/**
 ...
 * @experimental This attribute is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
export declare const ATTR_DB_OPERATION_PARAMETER = "db.operation.parameter";
/**
